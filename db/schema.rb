...
ActiveRecord::Schema.define(version: 2019_06_23_035602) do
  ...
  create_table "category_tricks", force: :cascade do |t|
    t.integer "trick_id"
    t.integer "category_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_category_tricks_on_category_id"
    t.index ["trick_id"], name: "index_category_tricks_on_trick_id"
  end
